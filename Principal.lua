...
local redzlib = {
    ...
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 100, 100)), -- Cinza médio na transição
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))  -- Branco no final
}),
["Color Hub 2"] = Color3.fromRGB(0, 0, 0),         -- Fundo preto
["Color Stroke"] = Color3.fromRGB(120, 120, 120),  -- Contorno cinza
["Color Theme"] = Color3.fromRGB(200, 200, 200),   -- Destaque/tema cinza claro
["Color Text"] = Color3.fromRGB(255, 255, 255),    -- Texto branco puro
["Color Dark Text"] = Color3.fromRGB(170, 170, 170) -- Texto secundário cinza
	},
	Info = {
		Version = "1.1.0"
	},
