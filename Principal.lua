...
local redzlib = {
    ...
    ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 200, 200)),  -- Cinza médio no início
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(230, 230, 230)),  -- Cinza claro na transição
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))   -- Branco puro no final
}),
["Color Hub 2"] = Color3.fromRGB(240, 240, 240),   -- Fundo branco acinzentado
["Color Stroke"] = Color3.fromRGB(180, 180, 180),  -- Contorno cinza suave
["Color Theme"] = Color3.fromRGB(255, 255, 255),   -- Tema branco (limpo e neutro)
["Color Text"] = Color3.fromRGB(50, 50, 50),       -- Texto cinza escuro (contraste perfeito)
["Color Dark Text"] = Color3.fromRGB(120, 120, 120) -- Texto secundário cinza médio
		}
	},
	Info = {
		Version = "1.1.0"
